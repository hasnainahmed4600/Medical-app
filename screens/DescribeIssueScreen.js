...
import { View, Text, ScrollView, FlatList, ActivityIndicator, Platform, styles } from 'react-native';
...
class DescribeIssueScreen extends Component {
  ...
  showUI() {
    ...
    if (this.props.isLoading == true) {
      ...
      return (
        <View>
          <FlatList
            ListHeaderComponent={<View style={{ flex: 1, alignItems: 'center', marginTop: 40 }}>
  ...
  render() {
    return (
      <View style={{ flex: 1 }}>       
        ...
        <Overlay visible={this.props.isTermsAndCondition} animationType="zoomIn"
          containerStyle={{ backgroundColor: 'rgba(0, 0, 0, 0.95)', }} childrenWrapperStyle={{ backgroundColor: '#eee', marginTop: 100, marginBottom: 40 }} >
          <View>
...
export default connect(mapStateToProps, { fetchIssue, makeIsTermsDone, makeIsTermsNotDone })(DescribeIssueScreen);